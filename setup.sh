...
gnome-terminal --tab --title="Terminal 3" -- bash -c "source install/local_setup.bash; source gantry_crane_venv/bin/activate; ros2 launch realsense_camera_yolo realsense_camera_yolo_launch.py; exec bash"
