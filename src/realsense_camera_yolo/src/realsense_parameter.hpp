...
#define CONTAINER_X_POSITION_MOVING_AVERAGE_WINDOW_SIZE 2
#define CONTAINER_Y_POSITION_MOVING_AVERAGE_WINDOW_SIZE 2
#define CONTAINER_Z_POSITION_MOVING_AVERAGE_WINDOW_SIZE 2
