...
class Controller:
    ...
    def get_control_signal(self, desired_trolley_position, desired_cable_length=None):
        ...
        # Control Signal Pos
        CS1 = self.Kpx * self.ex + self.Kix * self.posIntErr/100 + self.Kdx * dex/100
        # Control Signal Sway
        CS2 = self.Kptet * self.etet + self.Kitet * self.tetIntErr/100 + self.Kdtet * detet/100


        self.control_signal_trolley = CS1 + CS2
        self.control_signal_hoist = 0
...
if __name__ == "__main__":
    x_ref, teta_ref, t = x_reference(DURATION)
